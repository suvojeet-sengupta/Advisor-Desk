        ...
        child: Column(
          ...
          children: [
            ...
            _buildSalaryRow(
              ...
              Icons.card_giftcard,
              summary.isBonusAchieved ? Theme.of(context).colorScheme.tertiary : Theme.of(context).colorScheme.error,
            ),
            Padding(
              ...
              child: Text(
                ...
                style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      ...
                      color: summary.isBonusAchieved ? Theme.of(context).colorScheme.onSurfaceVariant : Theme.of(context).colorScheme.error,
                    ),
              ),
            ),
            _buildSalaryRow(
              ...
              Icons.star,
              summary.isCSATBonusAchieved ? Theme.of(context).colorScheme.tertiary : Theme.of(context).colorScheme.error,
            ),
            Padding(
              padding: const EdgeInsets.only(left: 48.0, bottom: 8.0),
              child: Text(
                ...
                style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      fontStyle: FontStyle.italic,
                      color: summary.isCSATBonusAchieved ? Theme.of(context).colorScheme.onSurfaceVariant : Theme.of(context).colorScheme.error,
                    ),
              ),
            ),
            _buildSalaryRow(
