...
class SupportWebviewScreen extends StatefulWidget {
  const SupportWebviewScreen({Key? key}) : super(key: key);
...
Page resource error:
  ...
  Future<void> _loadHtmlFromAssets() async {
    ...
    _controller.loadFlutterAsset('assets/web/support.html');
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'Support Advisor Desk'),
